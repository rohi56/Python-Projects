...
dbdetails = 'C:/python/Using Databases with Python/geodata.sqlite'
conn = sqlite3.connect(dbdetails)
cur = conn.cursor()
...
wheredata = 'C:\\python\\Using Databases with Python\\opengeo\\where.data'
fh = open(wheredata)
count = 0
nofound = 0
for line in fh:
